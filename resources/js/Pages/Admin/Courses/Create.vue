        ...
        <div class="max-w-2xl">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                <div class="rounded-xl bg-slate-800 border border-slate-700 p-6 space-y-6">
                    ...
                    <!-- Thumbnail -->
                    <div>
                        <label class="block text-sm font-medium text-slate-300 mb-2">サムネイル画像</label>
                        <input
                            type="file"
